...
Consider the barest, simplest control structure in Software Developement, the <i>if</i> statement. Lets think about this in C++, where we often write something like the following:
